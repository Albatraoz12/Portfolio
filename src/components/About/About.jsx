    ...
    <section className='about-section'>
      <div className='about-container'>
        ...
        <div className='about-wrapper'>
          ...
          <p className='about-paragraph'>
            Besides my technical abilities, I take pride in my adaptability and
            ability to think on my feet. I have a curious nature and constantly
            seek out new tools and techniques that align with the latest trends
            in the digital realm. I&apos;m passionate about staying up-to-date
